    ...
    <>
      <div className="mx-auto max-w-7xl bg-custom-white">
        ...
        <div className=" w-full top-[773px] absolute flex-col justify-center items-center gap-20 inline-flex">
          ...
          <div>
            <div  className="Text self-stretch text-zinc-800 text-[20px] font-bold font-['Playfair Display'] leading-[60px]">Contact Me</div>
            <div className="grid grid-flow-col gap-8">
            <div className="h-10 w-27 pr-2 rounded-lg bg-[#0D1117] flex justify-center">
              <img className="invert h-auto w-auto m-1"
